...
*If using the pre-compiled XIVOTPGenerator.jar file you can skip to step 10
...
Step 10: Configuring your Secret
...
Step 10.1: Getting Secret from QR code:
On this screen, a QR Code will appear. Right click the image and save it to somewhere on your PC, like your desktop.

Step 10.2: Putting the QR code into an app like authy ( backup incase of issues):
